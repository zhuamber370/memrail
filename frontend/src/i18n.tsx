...
const dictionaries: Record<Lang, Dictionary> = {
  en: {
    ...
    "tasks.execution.startHint": "Start this task by defining the first goal.",
    "tasks.execution.startGoalPlaceholder": "First goal title",
    ...
    "routes.subtitle": "Manage task-level execution flows and inspect step dependencies.",
    ...
    "routes.placeholderSpawnedFromNodeId": "Spawned from node ID (optional)",
    ...
    "routes.parentNodeOptional": "Parent node (optional)",
    "routes.nodeCreateAction": "Create Step",
    "routes.parentRoute": "Parent Route",
    "routes.spawnedFromNode": "Spawned From Node",
    "routes.parentNode": "Parent Node",
    "routes.parentHint": "Node parent links:",
    ...
    "routes.refinementStatus.rough": "Rough",
    "routes.refinementStatus.exploring": "Exploring",
    "routes.refinementStatus.decided": "Decided",
    "routes.refinementStatus.decomposed": "Decomposed",
  ...
  zh: {
    ...
    "tasks.execution.startHint": "开始任务时请先定义第一个目标。",
    "tasks.execution.startGoalPlaceholder": "首个目标标题",
    ...
    "routes.title": "执行流",
    "routes.subtitle": "管理任务级执行流，并查看步骤依赖关系。",
    "routes.create": "创建执行流",
    "routes.refresh": "刷新",
    ...
    "routes.placeholderSpawnedFromNodeId": "来源节点 ID（可选）",
    ...
    "routes.parentNodeOptional": "父节点（可选）",
    "routes.nodeCreateAction": "创建步骤",
    "routes.parentRoute": "父执行流",
    "routes.spawnedFromNode": "来源节点",
    "routes.parentNode": "父节点",
    "routes.parentHint": "节点父子关系：",
    ...
    "routes.refinementStatus.rough": "粗目标",
    "routes.refinementStatus.exploring": "探索中",
    "routes.refinementStatus.decided": "已决策",
    "routes.refinementStatus.decomposed": "已分解",
